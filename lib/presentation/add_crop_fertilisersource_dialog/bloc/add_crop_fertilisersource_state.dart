...
class AddCropFertiliserSourceState extends Equatable {
  AddCropFertiliserSourceState({
  ...
  AddCropFertiliserSourceModel? addLandandwatermgmtThreeModelObj;
  ...
  AddCropFertiliserSourceState copyWith({
    bool? biogasProductio,
    bool? mulchingvalue,
    bool? trash,
    bool? terracingvalue,
    ...
    return AddCropFertiliserSourceState(
