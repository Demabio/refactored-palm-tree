...
class AddCropPesticideState extends Equatable {
  AddCropPesticideState({
  ...
  AddCropPesticideModel? addLandandwatermgmtThreeModelObj;
  ...
  AddCropPesticideState copyWith({
    bool? biogasProductio,
    bool? mulchingvalue,
    bool? trash,
    bool? terracingvalue,
