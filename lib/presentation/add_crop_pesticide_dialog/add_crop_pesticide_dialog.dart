...
import 'bloc/add_crop_pesticide_bloc.dart';
...
class AddCropPesticideDialog extends StatelessWidget {
  const AddCropPesticideDialog({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<AddCropPesticideBloc>(
      create: (context) => AddCropPesticideBloc(AddCropPesticideState(
        addLandandwatermgmtThreeModelObj: AddCropPesticideModel(),
      ))
        ..add(AddCropPesticideInitialEvent()),
      child: AddCropPesticideDialog(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Expanded(
          child: SingleChildScrollView(
            child: Align(
              ...
              child: BlocSelector<AddCropPesticideBloc, AddCropPesticideState,
                    ...
                    children: List<Widget>.generate(
                      ...
                      (index) {
                        ...
                        return CBListWidget(
                          model,
                          onSelect: (value) {
                            context.read<AddCropPesticideBloc>().add(
        ...
        BlocSelector<AddCropPesticideBloc, AddCropPesticideState,
            AddCropPesticideModel?>(
          selector: (state) => state.addLandandwatermgmtThreeModelObj,
              ...
              child: Row(
                ...
                children: [
                  CustomElevatedButton(
                    ...
                    onTap: () {
                      context.read<AddCropPesticideBloc>().add(ResetCBs());
                    },
                  ),
                  CustomElevatedButton(
                    width: DeviceExt((95 / 841) * 100).h,
                    ...
                    buttonTextStyle: CustomTextStyles.bodyLarge16,
                    onTap: () {
                      context.read<AddCropPesticideBloc>().add(AddCBs(
