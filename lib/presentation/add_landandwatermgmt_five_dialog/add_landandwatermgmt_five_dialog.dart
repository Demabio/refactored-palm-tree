  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Expanded(
          child: SingleChildScrollView(
            child: Align(
              ...
              child: BlocSelector<AddLandandwatermgmtFiveBloc,
                  AddLandandwatermgmtFiveState, AddLandandwatermgmtFiveModel?>(
                selector: (state) => state.addLandandwatermgmtFiveModelObj,
                    ...
                    children: List<Widget>.generate(
                      ...
                      (index) {
                        ...
                        return CBListWidget(
                          model,
                          onSelect: (value) {
                            context.read<AddLandandwatermgmtFiveBloc>().add(
        ...
        BlocSelector<AddLandandwatermgmtFiveBloc, AddLandandwatermgmtFiveState,
              ...
              child: Row(
                ...
                children: [
                  ...
                  CustomElevatedButton(
                    ...
                    buttonTextStyle: CustomTextStyles.bodyLarge16,
                    onTap: () {
                      context.read<AddLandandwatermgmtFiveBloc>().add(AddCBs(
