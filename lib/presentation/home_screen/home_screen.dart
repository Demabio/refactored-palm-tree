                    ...
                    child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          Align(
                              ...
                              child: Padding(
                                  padding:
                                      EdgeInsets.only(left: 24.h, top: 60.v),
                          ...
                          Align(
                              ...
                              child: Padding(
                                  padding:
                                      EdgeInsets.only(left: 24.h, top: 46.v),
                          ...
                          Align(
                              ...
                              child: Padding(
                                  padding:
                                      EdgeInsets.only(left: 24.h, top: 26.v),
                                  child: Text("msg_registration_overview".tr,
                                      style: CustomTextStyles
                                          .titleMediumSemiBold))),
                          Container(
                              margin: EdgeInsets.only(
                                  left: 23.h, top: 9.v, right: 23.h),
                              padding: EdgeInsets.symmetric(
