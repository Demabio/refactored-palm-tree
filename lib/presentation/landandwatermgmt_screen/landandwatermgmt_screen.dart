        ...
        child: SafeArea(
          child: Scaffold(
            ...
            body: Container(
              ...
              padding: EdgeInsets.symmetric(horizontal: 14.h, vertical: 2.v),
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 2.h, top: 15.v, bottom: 5.v),
                    padding:
                        EdgeInsets.symmetric(horizontal: 5.h, vertical: 15.v),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                            padding: EdgeInsets.only(left: 4.h, top: 7.v),
                            child: Row(
                                mainAxisAlignment:
                        ...
                        Padding(
                            padding: EdgeInsets.only(left: 4.h, top: 21.v),
                            child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  SizedBox(
                        ...
                        Visibility(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                  padding: EdgeInsets.only(left: 4.h, top: 8.v),
                                  child: Text("msg_for_irrigation_schemes".tr,
                                      style:
                                          CustomTextStyles.labelMediumPrimary)),
                              BlocSelector<
                                      LandandwatermgmtBloc,
