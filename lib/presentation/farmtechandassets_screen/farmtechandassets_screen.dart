                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                                padding: EdgeInsets.only(left: 2.h, top: 9.v),
                                child: Text("msg_source_of_power".tr,
                                    style:
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      Padding(
                                          ...
                                          child: Text("lbl_labour_source2".tr,
                                              style: CustomTextStyles
                                                  .labelMediumPrimary)),
                                      Text(state.farm?.labourSource ?? "N/A",
                                          style: theme.textTheme.labelMedium)
                                    ])),
                            Padding(
                                padding: EdgeInsets.only(left: 2.h, top: 11.v),
                                child: Text("msg_farmer_machinery".tr,
                                    style:
                                        CustomTextStyles.labelMediumPrimary)),
                            BlocSelector<
                                    FarmtechandassetsBloc,
                            ...
                            Padding(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      SizedBox(
                                          width: 186.h,
                                          child: Text("msg_who_owns_most_of".tr,
                                              maxLines: 2,
                                      ...
                                      Padding(
                                          padding: EdgeInsets.only(
                                              left: 77.h, bottom: 18.v),
                                          child: Text("lbl_self_family".tr,
                                              style:
                                                  theme.textTheme.labelMedium))
                                    ])),
                            Padding(
                                padding: EdgeInsets.only(left: 2.h, top: 8.v),
                                child: Text("msg_which_farm_structures".tr,
                                    style:
                                        CustomTextStyles.labelMediumPrimary)),
